...
public class DelayImage
{
  ...
  public DelayImage(Camera camera, Material material)
  {
    _camera = camera;
    _material = material;
  ...
  public void Draw(Texture cameraFeed)
  {
    ...
    // Draw image with screen dimensions
  ...
  {
    // adjust UV of HumanStencilTexture thank you unity forum
    if (Input.deviceOrientation == DeviceOrientation.LandscapeRight)
    {
      _material.SetFloat(PropertyID_UVMultiplierLandScape, LandScapeUVFactor(humanStencilTexture));
    ...
    {
      _material.SetFloat(PropertyID_UVMultiplierPortrait, PortraitUVFactor(humanStencilTexture));
  ...
  private float LandScapeUVFactor(Texture textureFromAROcclusionManager)
  {
  ...
  private float PortraitUVFactor(Texture textureFromAROcclusionManager)
  {
